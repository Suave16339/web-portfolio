    ...
    <section className="serviceSection shell" id="request-service" aria-labelledby="service-title">
      ...
      <form className="serviceForm" onSubmit={submitRequest}>
        ...
        <div className="serviceFields">
          ...
          <label htmlFor="request-email">Email address *<input data-slot="input" id="request-email" name="email" type="email" inputMode="email" autoComplete="email" required maxLength={254} placeholder="you@example.com" /></label>
